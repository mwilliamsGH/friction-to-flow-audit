  ...
  return (
    <section className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-900">The "Magic Button"</h3>
          <p className="text-sm text-gray-500 uppercase tracking-wider">Automation Opportunities</p>
        </div>
      </div>

      {frictionContext && (
        <NeoCard variant="small" className="bg-yellow-50/50">
